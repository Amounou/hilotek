  ...
  head: () => ({
    meta: [
      ...
      { title: "HiloTek Services & Tech — Boutique, maintenance, développement, formation" },
      {
        name: "description",
        content:
          "Découvrez HiloTek : boutique high-tech, maintenance, développement web/mobile, cybersécurité, cloud et rédaction de mémoire.",
      },
      { name: "author", content: "HiloTek Services & Tech" },
      { property: "og:title", content: "HiloTek Services & Tech — Boutique, maintenance, développement, formation" },
      { property: "og:description", content: "Découvrez HiloTek : boutique high-tech, maintenance, développement web/mobile, cybersécurité, cloud et rédaction de mémoire." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1b3e92" },
      { name: "twitter:title", content: "HiloTek Services & Tech — Boutique, maintenance, développement, formation" },
      { name: "twitter:description", content: "Découvrez HiloTek : boutique high-tech, maintenance, développement web/mobile, cybersécurité, cloud et rédaction de mémoire." },
